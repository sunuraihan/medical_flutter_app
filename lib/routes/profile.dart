                ...
                itemBuilder: (context, index) {
                  return doctorCard(
                    ...
                    medicalEducation: doctorProfileSnapshot.docs[index]
                        ["medicalEducation"],
                    residency: doctorProfileSnapshot.docs[index]["residency"],
                    internship: doctorProfileSnapshot.docs[index]["internship"],
                    fellowship: doctorProfileSnapshot.docs[index]["fellowship"],
                    biography: doctorProfileSnapshot.docs[index]["biography"],
                  );
                }),
          )
        : Container(
